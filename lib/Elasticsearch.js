        ...
        self.client.indices.create({
            ...
            body: {
                ...
                mappings: {
                    torrent: {
                        properties: {
                            id:     {type: "string", analyser: "not_analyzed", include_in_all: false},
                            title:  {type: "string", analyser: "toy_analyser", include_in_all: true},
                            genres: {type: "string", analyser: "toy_analyser", include_in_all: true},
                            torrent_info_url: {
                               type: "string", analyser: "not_analyzed", include_in_all: false
                            },
