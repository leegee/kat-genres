...
module.exports = function Importer (options){
    ...
    if (! this.options.db){
        throw new Error('No db option supplied');
    }
};
...
module.exports.prototype.elasticsearch = null;
...
module.exports.prototype.loadTorrentsFromCSV = function (next) {
    ...
    parser.on('readable', function(){
        ...
        while ((record = parser.read()) !== null){
            promises.push(
                new Torrent({db: self.options.db}, record)
                        .saveWithMetaInfo({ elasticsearch: self.elasticsearch })
            );
        }
    });
