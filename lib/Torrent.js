...
module.exports.prototype.save = function (next) {
    ...
    this.setTitle( function () {
        console.debug('setTitle callback - call setGenres');
...
module.exports.prototype.setTitleFromHTML = function (html) {
    ...
    if (m){
        ...
        console.error("No title from ", html);
    }
    return m? true : false;
};
...
module.exports.prototype.setGenres = function (next) {
    ...
    if (this.katFields.torrent_category === 'Movies'){
        ...
        this.genres = new Omdb().get( this.title, next );
    }
    else if (this.katFields.torrent_category === 'TV'){
        console.debug('setGenres Dbpedia');
        this.genres = new Dbpedia().get( this.title, next );
    }
};
